...
const Module2 = () => {
  ...
  <div className="w-70 h-60 rounded-lg overflow-hidden bg-black/10 flex items-center justify-center">
    <img 
      src="/media/images/foto1.jpeg"
      alt="Foto 1"
      className="max-w-full max-h-full object-contain"
    />
  </div>

  <div className="w-70 h-50 rounded-lg overflow-hidden bg-black/10 flex items-center justify-center">
    <img 
      src="/media/images/foto2.jpeg"
      alt="Foto 2"
      className="max-w-full max-h-full object-contain"
    />
  </div>
          ...
          {/* CARD DE DEMONSTRAÇÃO MULTIMÍDIA */}
          <Card className="mb-8 bg-gradient-card border-border/50 shadow-card">
            <CardContent className="p-6">
              <div className="mt-6 p-4 bg-white rounded-lg shadow border border-gray-200">
                ...
                <p className="text-sm text-gray-600 mb-2">Explicação do Módulo 2:</p>
                <audio controls className="w-full mb-4">
                  <source src="/media/audio/modulo2.ogg" type="audio/mpeg" />
                </audio>
